...
var userslist= JSON.parse( localStorage.getItem(
    'all_users'));
...

{
   ...
   if(flag){
    ...
    localStorage.setItem('Market_all_users',JSON.stringify(userslist));
    alert("you have signed up successfuly , redierect to login page ");
    window.location.replace('/MarketPlace/login.html');
